...
// --- VICTORY-ONLY SOUND ENGINE ---
const SFX = {
  // "Pop": Sharp, high-pitch pop for standard completion
  success: new Audio('https://assets.mixkit.co/active_storage/sfx/2003/2003-preview.mp3'),
  
  // "Crush": Heavy cinematic impact 
  crush: new Audio('https://assets.mixkit.co/active_storage/sfx/2570/2570-preview.mp3'),
  
  // "Fireworks": REAL Whistle and Boom (No more UFO)
  fireworks: new Audio('https://cdn.pixabay.com/audio/2022/01/18/audio_8db1f115a9.mp3'),
};
...
function VisionBoard({ session }) {
  ...
  const toggleCompleted = async (mission) => { 
      ...
      if (newCompleted) {
          ...
          else playSound('success'); // New Pop sound
      }
